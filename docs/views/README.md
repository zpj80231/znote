...
我不知道会不会有人来到这里，也许你只是偶然点进来，也许你什么都不会留下。

但没关系。

这个地方，本来就不是为了被很多人看到。它更像是一个被时间忽略的空档，安静、缓慢，也不需要被理解。
...
还有一些不成体系的念头，一些半途而废的尝试，一些说不上重要、却又舍不得丢掉的瞬间。

它只是一个角落 —— 记录我的点滴，安放我的心声，以及那些在现实里说不出口的东西。
